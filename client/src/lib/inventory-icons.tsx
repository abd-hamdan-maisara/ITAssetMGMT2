...
export function InventoryIcon({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M2 5a2 2 0 0 1 2-2h5a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5Z" />
      <path d="M15 13h4" />
      <path d="M15 7h4" />
      <path d="M15 5a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2V5Z" />
      <path d="M15 11a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-2Z" />
    </svg>
  );
}

export function InventoryChart({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function CredentialIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M10.85 12.15l7.5-7.5a2.121 2.121 0 0 1 3 3l-7.5 7.5" />
